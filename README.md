...
One further consideration is that flagging a pet as high-risk does not guarantee a high-cost claim will be avoided after outreach. Even among correctly identified high-risk pets, some will not be reachable, some will not follow advice, and some will still experience unavoidable high-cost events despite intervention. As a result, Precision@K and Lift@K quantify targeting efficiency, but they do not directly quantify financial impact. The only robust way to estimate the true business value of changing the threshold is to run a controlled experiment (A/B or multivariate test), randomly assigning eligible high-risk pets to an outreach group versus a control group and measuring differences in outcomes such as high-cost claim incidence, claim cost, and net savings after intervention costs. This allows the business to estimate the causal impact of outreach and select an operating point that maximises expected net value rather than optimising ranking metrics alone.
In other words, model metrics tell us who to target; experimentation tells us whether targeting changes behaviour and saves money.
...
Claims history is one of the strongest behavioural differentiators. Severe claim rates rise sharply with increasing historical claim count: from 4.3% for pets with zero claims in the past 12 months, to 9.3% with one claim, 12.1% with two, 14.9% with three, 21.1% with four, and 32.3% for pets with five claims. This represents approximately a 7–8× increase in risk between zero-claim and high-frequency claim cohorts, indicating that recent claims behaviour is a powerful and economically material segmentation lever.

Shorter-term utilisation patterns show a similar, though milder, gradient. Policies with no vet visits in the past six months show a 7.1% severe claim rate, increasing steadily to 8.9% among pets with four or more visits. In addition, the adjusted claim severity score exhibits a structural breakpoint at approximately 0.6; above this level, severe claim likelihood accelerates materially, identifying a distinct high-severity behavioural cohort not fully explained by age or breed alone.
...
In summary, portfolio risk is concentrated in senior age bands, specific higher-risk breed groups, high historical claim frequency cohorts, increasing recent utilisation segments, and policies exceeding the severity score threshold. These cohort-level drivers provide a clear basis for pricing calibration review and improved actuarial alignment across segments.
